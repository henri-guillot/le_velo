...
export default class extends Controller {
  static targets = ["startDate", "endDate", "priceContainer", "priceDisplay", "pricePerDay", "durationDisplay", "bikeStyle"];
  ...
  priceDisplay() {
    ...
    if (!isNaN(start) && !isNaN(end)) {
      ...
      this.durationDisplayTarget.innerText = `You will send a booking request for ${this.bikeStyleTarget.value} for ${duration} ${day}.`;
